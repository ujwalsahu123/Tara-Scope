# get the raw gryo data using serial monitor , stores {timestamp millie sec, x, y ,z}
# stores it in raw.txt file , it dosent do scaling (lsb -> dps) here. 
# we use the raw txt file and scale it to dps and do analysis and calib, etc...
