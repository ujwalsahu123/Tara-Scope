...
# For 125 dps data (X-axis):
# ARW ≈ 0.006206 × 60 = 0.37236 deg/√hr
...
# For 125 dps data (X-axis):
# Bias Instability ≈ (0.0004357 / 0.664) × 3600 ≈ 2.36 deg/hr
...
# ---------------- CONFIG ---------------- 
DATA_FILE = "Analysis_big_data/data_dps_125dps_Nofilter.txt"   # use dps wala data for analysis.  # t_ms,gx_dps,gy_dps,gz_dps
